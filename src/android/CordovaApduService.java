...
public class CordovaApduService extends HostApduService {
    ...
    public CordovaApduService() {
        cordovaApduService = new CordovaApduService();  // Set the initial value for the class attribute x
    }
     ...
     * their meta-data entry, you will only get called if the user has explicitly
     * selected your
